...
python eval.py --dataset FaceForensics --part manipulated_sequences/DeepFakeDetection/c23 --default_target 1
python eval.py --dataset FaceForensics --part manipulated_sequences/Deepfakes/c23 --default_target 1
python eval.py --dataset FaceForensics --part manipulated_sequences/Face2Face/c23 --default_target 1
python eval.py --dataset FaceForensics --part manipulated_sequences/FaceSwap/c23 --default_target 1
python eval.py --dataset FaceForensics --part manipulated_sequences/NeuralTextures/c23 --default_target 1
