...
parser.add_argument('--save_dir', default='test_output', type=str, metavar='PATH',
                    help='path to save generated frames (default: demo)')
parser.add_argument('--gpu', default=0, type=str, help='cuda_visible_devices')

parser.add_argument('-m', '--amp', default=4.0, type=float,
...
parser.add_argument('--video_path', default='test_data/baby', type=str,
